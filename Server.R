...
server <- function(input, output){
  ...
  output$price_chart <- renderPlot({
    ...
    price_chart <- ggplot(price_data) +
      ...
      theme(
        plot.background = element_rect(fill = "#f7f9fA"),
        panel.background = element_rect(fill = "#f7f9fA"),
        axis.text.x = element_text(color = "#6b3333", angle = 45, hjust = 1, vjust = 1),
        axis.text.y = element_text(color = "#6b3333"),
        axis.title.y = element_text(color = "#6b3333"),
        axis.title.x = element_text(color = "#6b3333"),
        plot.title = element_text(color = "#6b3333"),
        plot.subtitle = element_text(color = "#6b3333"),
        plot.caption = element_text(color = "#6b3333", face = "italic", size = 6),
